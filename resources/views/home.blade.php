...
<html lang="en">
    <head>
        ...
        <title>Kenya Seed Company | Home</title>
    ...
    <body class="scroll-smooth">
        ...
        <main class="flex gap-10 flex-col pb-10">
            <section
                class="bg-[url('../../public/assets/images/Overlay_Image_BG.png')] bg-no-repeat bg-cover bg-center bg-[#0D492999] bg-blend-multiply text-white min-h-[720px] flex items-center justify-center"
            >
                <div class="flex flex-col gap-5 text-start max-w-screen-xl">
                    <h3 class="text-lg font-semibold uppercase">
                        harvesting innovation
                    </h3>
                    <h1 class="text-[80px] leading-tight font-bold">
                        Revolutionizing Vegetable Agriculture
                    </h1>
                    <p class="text-base">
                        Welcome to Kenya Seed Company, an entity that harmonizes
                        the needs of food production, environmental stewardship,
                    ...
                    <div class="mt-5">
                        <a
                            href="#"
                            type="button"
                            class="px-9 text-black text-base font-semibold bg-tertiary py-[22px] capitalize"
                        >
                            discover more
                        </a>
                    </div>
            ...
            <section class="max-w-screen-xl mx-auto grid grid-cols-2 gap-5 p-5">
                <article class="flex gap-[30px] flex-col">
                    <div>
                        <h3 class="text-tertiary">ABOUT US</h3>
                        <h2
                            class="text-primary font-semibold text-[50px] leading-[64px]"
                        >
                            Fostering Expansion in Agriculture
                        </h2>
                        <p>
                            Kenya Seed Company Limited (KSC) is a state
                            corporation that produces and markets top quality
                            certified seeds with an overall objective of adding
                            value to the farming business and contributing to
                            food self-sufficiency in Kenya and beyond. The
                            Company was incorporated in Kenya on 2nd July 1956
                            to initially promote the use of improved strains of
                            pasture seed developed by then National Agricultural
                            Research Station based in Kitale. Two years later
                            KSC started an enterprise to produce commercial
                            sunflower for the European bird feed market in order
                            to sustain its financial needs.
                        </p>
                    </div>
                    ...
                    <a
                        href="#"
                        type="button"
                        class="bg-primary text-white py-[18px] px-[52px] w-fit"
                        >Learn More</a
                    >
                </article>

                <article class="relative flex flex-grow w-full">
                    <div class="absolute -top-24 right-2">
                        <img
                            src="{{ asset('assets/images/farmer.png') }}"
                            alt="A farmer looking at his bumper harvest"
                        />
                    </div>

                    <div class="absolute -bottom-28">
                        <img
                            src="{{ asset('assets/images/wheat.png') }}"
                            alt="Wheat flour in the fields"
                        />
                    </div>
                </article>
            </section>
            ...
            <section
                class="border-l-[67px] border-primary flex flex-col items-center justify-center text-center mt-20 p-5"
            >
                <article
                    class="gap-5 flex flex-col max-w-screen-xl mx-auto items-center"
                >
                    <div class="max-w-[860px]">
                        <h3 class="uppercase text-tertiary">our products</h3>
                        <h1
                            class="text-primary font-semibold text-[50px] leading-[64px]"
                        >
                            Quality Seeds for Every Crop
                        </h1>
                        <p class="">
                            Discover high-quality seeds and expert support to
                            boost your farm's productivity and sustainability.
                            At Kenya Seed Company, we are dedicated to providing
                            farmers with premium seed varieties that are
                            tailored to Kenya's diverse climates.
                        </p>
                    </div>

                    <div class="gap-10 grid grid-cols-3 items-center">
                        <div
                            class="text-center flex justify-center flex-col gap-[18px]"
                        >
                            <img
                                src="{{ asset('assets/images/maize.png') }}"
                                alt="Maize plant"
                            />

                            <div class="flex gap-1 flex-col">
                                <h2 class="font-bold text-[25px]">Maize</h2>
                                <p class="text-[15px]">
                                    Highland Maize Varieties These varieties do
                                    well in high rainfall areas with well
                                    drained good soils where rainfall
                                    distribution lasts about 150-180 days
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            <img
                                src="{{
                                    asset('assets/images/wheat-plant.png')
                                }}"
                                alt="Wheat plant"
                            />

                            <div class="flex gap-1 flex-col">
                                <h2 class="font-bold text-[25px]">Wheat</h2>
                                <p class="text-[15px]">
                                    Wheat Varieties   VARIETY ALTITUDE (m) a.s.l
                                    YIELD (90kg bags/ acre MATURITY PERIOD
                                    (days) SPECIAL ATTRIBUTES KS Mwamba
                                    1800-2400 22-25 125 High yielding.
                                </p>
                            </div>
                        </div>
                        ...
                        >
                            <img
                                src="{{ asset('assets/images/sunflower.png') }}"
                                alt="Sunflower plant"
                            />

                            <div class="flex gap-1 flex-col">
                                <h2 class="font-bold text-[25px]">Sunflower</h2>
                                <p class="text-[15px]">
                                    Sunflower Varieties   VARIETY OPTIMAL
                                    PRODUCTION LEVELS YIELD (90kg bags/ acre
                                    SPECIAL ATTRIBUTES RECOMMENDED GROWING AREAS
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section
                class="text-white bg-[url('../../public/assets/images/Maize_field.jpg')] bg-no-repeat bg-cover bg-center bg-[#0D492999] bg-blend-multiply"
            >
                <div
                    class="max-w-screen-xl m-auto grid grid-cols-4 p-10 gap-11"
                >
                    <article
                    ...
                    >
                        ...
                        >
                            <path
                                d="M13.2242 9.61108H9.52989C9.03999 9.61108 8.57016 9.87047 8.22376 10.3322C7.87735 10.7939 7.68274 11.4201 7.68274 12.0731V39.1552C7.68274 39.8081 7.87735 40.4343 8.22376 40.8961C8.57016 41.3578 9.03999 41.6172 9.52989 41.6172H28.0013C28.4912 41.6172 28.9611 41.3578 29.3075 40.8961C29.6539 40.4343 29.8485 39.8081 29.8485 39.1552V12.0731C29.8485 11.4201 29.6539 10.7939 29.3075 10.3322C28.9611 9.87047 28.4912 9.61108 28.0013 9.61108H24.3071"
                                stroke="white"
                                stroke-width="1.5"
                            ...
                            />
                            <path
                                d="M16.9185 19.459H26.1542M16.9185 26.845H26.1542M16.9185 34.231H26.1542M11.377 19.459H13.2242M11.377 26.845H13.2242M11.377 34.231H13.2242M15.0713 7.14893H22.4599C22.9498 7.14893 23.4196 7.40831 23.766 7.87003C24.1124 8.33175 24.307 8.95797 24.307 9.61093C24.307 10.2639 24.1124 10.8901 23.766 11.3518C23.4196 11.8135 22.9498 12.0729 22.4599 12.0729H15.0713C14.5814 12.0729 14.1116 11.8135 13.7652 11.3518C13.4188 10.8901 13.2242 10.2639 13.2242 9.61093C13.2242 8.95797 13.4188 8.33175 13.7652 7.87003C14.1116 7.40831 14.5814 7.14893 15.0713 7.14893Z"
                                stroke="white"
                                stroke-width="1.5"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <p class="text-xl font-semibold">Years of Existence</p>
                    </article>
                    ...
                    >
                        ...
                        >
                            <g clip-path="url(#clip0_11_209)">
                                <path
                                    d="M22.0118 29.7057C24.1009 28.5216 25.7394 26.6793 26.6715 24.4662C27.6037 22.2532 27.7771 19.7938 27.1649 17.4718C26.5526 15.1499 25.1889 13.0958 23.2867 11.6302C21.3845 10.1646 19.0507 9.36975 16.6493 9.36975C14.248 9.36975 11.9141 10.1646 10.0119 11.6302C8.10968 13.0958 6.74606 15.1499 6.13376 17.4718C5.52147 19.7938 5.69493 22.2532 6.62709 24.4662C7.55926 26.6793 9.1977 28.5216 11.2868 29.7057C7.41488 30.9401 4.0897 33.4769 1.87618 36.8851C1.71307 37.1349 1.65591 37.4394 1.71727 37.7314C1.77863 38.0234 1.95348 38.2791 2.20337 38.4422C2.45325 38.6054 2.75769 38.6625 3.04972 38.6012C3.34175 38.5398 3.59745 38.3649 3.76056 38.1151C5.1567 35.9685 7.06687 34.2045 9.31768 32.9835C11.5685 31.7624 14.0886 31.1228 16.6493 31.1228C19.21 31.1228 21.7301 31.7624 23.9809 32.9835C26.2317 34.2045 28.1419 35.9685 29.5381 38.1151C29.7118 38.3377 29.9629 38.4869 30.2415 38.5329C30.5202 38.579 30.8059 38.5186 31.0421 38.3637C31.2782 38.2088 31.4475 37.9707 31.5162 37.6968C31.5849 37.4228 31.5481 37.1331 31.4131 36.8851C29.2019 33.4786 25.8803 30.942 22.0118 29.7057ZM8.02431 20.2501C8.02431 18.5442 8.53015 16.8766 9.47788 15.4583C10.4256 14.0399 11.7726 12.9344 13.3487 12.2816C14.9247 11.6288 16.6589 11.458 18.332 11.7908C20.005 12.1236 21.5419 12.945 22.7481 14.1513C23.9543 15.3575 24.7758 16.8943 25.1086 18.5674C25.4414 20.2405 25.2706 21.9747 24.6178 23.5507C23.965 25.1267 22.8595 26.4738 21.4411 27.4215C20.0227 28.3692 18.3552 28.8751 16.6493 28.8751C14.3627 28.8721 12.1707 27.9624 10.5538 26.3456C8.93694 24.7287 8.02728 22.5366 8.02431 20.2501ZM47.5868 38.4376C47.3371 38.6005 47.033 38.6577 46.7412 38.5965C46.4494 38.5353 46.1938 38.3608 46.0306 38.1113C44.6369 35.9645 42.7282 34.2006 40.4782 32.9803C38.2283 31.7601 35.7088 31.1223 33.1493 31.1251C32.8509 31.1251 32.5648 31.0065 32.3538 30.7956C32.1428 30.5846 32.0243 30.2984 32.0243 30.0001C32.0243 29.7017 32.1428 29.4155 32.3538 29.2046C32.5648 28.9936 32.8509 28.8751 33.1493 28.8751C34.4194 28.8738 35.6735 28.592 36.8221 28.0499C37.9707 27.5077 38.9854 26.7186 39.7937 25.7389C40.6019 24.7592 41.1839 23.6131 41.4979 22.3824C41.8119 21.1518 41.8502 19.8669 41.6101 18.6197C41.3701 17.3725 40.8575 16.1937 40.1091 15.1676C39.3606 14.1414 38.3948 13.2932 37.2806 12.6836C36.1664 12.074 34.9313 11.7179 33.6635 11.6409C32.3957 11.5639 31.1266 11.7679 29.9468 12.2382C29.8094 12.2944 29.6622 12.3229 29.5137 12.3221C29.3653 12.3212 29.2184 12.2909 29.0817 12.233C28.945 12.1751 28.8211 12.0907 28.7172 11.9846C28.6132 11.8786 28.5313 11.7531 28.4761 11.6152C28.4209 11.4774 28.3936 11.33 28.3956 11.1815C28.3977 11.033 28.4291 10.8865 28.4881 10.7502C28.5471 10.6139 28.6324 10.4907 28.7393 10.3876C28.8461 10.2845 28.9723 10.2035 29.1106 10.1494C31.6696 9.1292 34.5205 9.11821 37.0873 10.1187C39.6541 11.1192 41.7456 13.0565 42.9392 15.5395C44.1328 18.0224 44.3396 20.8658 43.5178 23.4953C42.696 26.1247 40.9069 28.3443 38.5118 29.7057C42.3837 30.9401 45.7089 33.4769 47.9224 36.8851C48.0833 37.1356 48.1383 37.4397 48.0754 37.7307C48.0125 38.0217 47.8368 38.2759 47.5868 38.4376Z"
                                    fill="white"
                                />
                            </g>
                            <defs>
                                <clippath id="clip0_11_209">
                                    <rect
                                        ...
                                        height="48"
                                        fill="white"
                                        transform="translate(0.899307)"
                                    />
                                </clippath>
                            </defs>
                        </svg>
                        <h1 class="text-5xl font-bold">1000+</h1>
                        <p class="text-xl font-semibold">Happy Farmers</p>
                    </article>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M25.5082 22.5C25.5082 16.977 22.1493 12.5 18.0056 12.5C13.8619 12.5 10.503 16.977 10.503 22.5M10.503 23.5C6.01797 24.704 3.00043 26.956 3.00043 29.534C3.00043 33.381 9.71826 36.5 18.0056 36.5C26.293 36.5 33.0108 33.381 33.0108 29.534C33.0108 26.956 29.9933 24.704 25.5082 23.5"
                                stroke="white"
                                stroke-width="4"
                            />
                            <path
                                d="M10.503 22.5C11.2533 23.333 13.5041 26.5 18.0056 26.5C22.5072 26.5 24.758 23.5 25.5082 22.5M14.2543 25.5L15.7549 20.5"
                                stroke="white"
                                stroke-width="4"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <h1 class="text-5xl font-bold">250+</h1>
                    ...
                    >
                        ...
                        >
                            <path
                                d="M25.79 13.3503C24.1632 9.63462 21.8537 6.54667 19.0843 4.38418L18.5916 4L18.0989 4.38418C15.2823 6.57552 12.9435 9.72825 11.3178 13.5252C9.69213 17.3221 8.83691 21.6292 8.8382 26.0132C8.8382 26.2989 8.84189 26.5889 8.84908 26.8755C8.94699 30.76 10.0489 34.0287 12.0358 36.328C13.5563 38.0877 15.5066 39.1619 17.6079 39.4181V44H19.5758V22.7765H17.6076V36.7482C14.2829 36.229 10.9738 33.0627 10.8157 26.7853C10.8092 26.5287 10.8058 26.2689 10.8058 26.0132C10.8117 22.2278 11.5288 18.506 12.8903 15.1953C14.2518 11.8846 16.2132 9.09279 18.5916 7.08048C20.9699 9.09283 22.9313 11.8846 24.2927 15.1954C25.6542 18.5061 26.3712 22.2278 26.3771 26.0132C26.3771 26.2689 26.3738 26.5287 26.3672 26.7853C26.2408 31.8071 24.0976 34.8376 21.5432 36.1151V38.9228C22.8687 38.4163 24.0979 37.5313 25.1473 36.3279C27.1342 34.0285 28.2362 30.7599 28.3341 26.8754C28.3413 26.5889 28.345 26.2988 28.345 26.0132C28.3467 21.5605 27.4645 17.1883 25.79 13.3503Z"
                                fill="white"
                            />
                        </svg>
                        <h1 class="text-5xl font-bold">1300+</h1>
                        <p class="text-xl font-semibold">
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    >
                        ...
                        <p class="">
                            Stay informed with the latest in agriculture through
                            our blog, where we share expert advice, industry
                            news, and updates on the newest trends and
                    ...
                    <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        >
                            ...
                            >
                            <h2
                                class="my-2 text-2xl font-bold tracking-tight text-primary dark:text-white"
                            >
                                <a href="#"
                                    >Maximizing Crop Yields: Top Tips for Kenyan
                                    Farmers</a
                                >
                            </h2>
                            <p
                            ...
                            >
                                ...
                                changes! After months of preparation and some
                                hard work, we moved to our new office.
                            </p>
                        ...
                        >
                            ...
                            >
                                <a href="#"
                                    >Seed Selection 101: Choosing the Right seed
                                    for Your Farm</a
                                >
                            </h2>
                            <p
                        ...
                        >
                            ...
                            >
                                <a href="#"
                                    >A Comprehensive Guide to Maize Farming</a
                                >
                            </h2>
                            <p
                                class="mb-4 font-light text-gray-500 dark:text-gray-400"
            ...
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4">
                    <h2
                        class="mb-8 lg:mb-16 text-3xl font-extrabold tracking-tight leading-tight text-center text-primary dark:text-white md:text-4xl"
                    >
                        Our Partners
                    </h2>
                    <div
                    ...
                    >
                        <a href="#" class="flex justify-center items-center">
                            <svg
                                class="h-9 hover:text-primary dark:hover:text-white"
                                viewBox="0 0 125 35"
                                fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <a href="#" class="flex justify-center items-center">
                            <svg
                                class="h-8 hover:text-primary dark:hover:text-white"
                                viewBox="0 0 151 34"
                                fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                        ...
                        <a href="#" class="flex justify-center items-center">
                            <svg
                                class="h-6 hover:text-primary dark:hover:text-white"
                                viewBox="0 0 124 21"
                                fill="currentColor"
                                xmlns="http://www.w3.org/2000/svg"
                            >
